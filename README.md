...
and Python (Sections 4.1-4.4 and 5: machine-learning prediction, assignment
optimisation, and knowledge-growth simulation).

The kit generates **12 figures** and **19 tables** across Sections 3-5
and Appendices B-G.
...
**Appendix G -- Post-stratification weighted ML analysis** (written to `results/empirical4.1_4.4_weighted/` and `results/empirical5_weighted/`)
...
This reproduces Section 3 (ordered logit models, robustness checks,
post-stratification weighted tables) and writes all Section 3 and
...
### Step 4 -- Run the Python workflow (Sections 4.1-4.4 and 5)

```powershell
python run_empirical4_and_5.py
```
